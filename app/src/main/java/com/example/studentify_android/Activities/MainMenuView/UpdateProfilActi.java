...
import com.example.studentify_android.Activities.StartView.RegisterActi;
...
public class UpdateProfilActi extends AppCompatActivity {
    ...
    @OnClick(R.id.changePasswordButton) void onChangePsw() {
        ...
        final EditText mOldPswd = new EditText(this);
        final EditText mNewPswd = new EditText(this);
        ...
        alertDialog.setOnShowListener(dialog -> {
            ...
            buttonNegative.setOnClickListener(view -> {
                Toast.makeText(this, "Modification annulée", Toast.LENGTH_LONG);
            });
        });
        alertDialog.show();
