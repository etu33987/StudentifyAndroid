...
// Ce ViewModel ne sert fondamentatlement à rien
// Mise à jour automatique des éléments dans un ScrillView
// Je laisse quand même la classe au cas où (le mieux aurait été d'en mettre pour chaque liste)
